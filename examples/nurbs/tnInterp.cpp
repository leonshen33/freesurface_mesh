...
int main(){
  ...
  Vector_Point3Dd points(10) ;

  points[0] = Point3Dd(20,20,0) ;
  points[1] = Point3Dd(20,80,0) ;
  points[2] = Point3Dd(20,120,0) ;
  points[3] = Point3Dd(20,160,0) ;
  points[4] = Point3Dd(80,200,0) ;
  points[5] = Point3Dd(120,200,0) ;
  points[6] = Point3Dd(160,160,0) ;
  points[7] = Point3Dd(160,120,0) ;
  points[8] = Point3Dd(120,80,0) ;
  points[9] = Point3Dd(80,80,0) ;


  Vector_Point3Dd deriv(10) ;
  deriv[0] = Point3Dd(0,1,0) ;
  deriv[1] = Point3Dd(0,1,0) ;
  deriv[2] = Point3Dd(0,1,0) ;
  deriv[3] = Point3Dd(0,1,0) ;
  deriv[4] = Point3Dd(1,0,0) ;
  deriv[5] = Point3Dd(1,0,0) ;
  deriv[6] = Point3Dd(0,-1,0) ;
  deriv[7] = Point3Dd(0,-1,0) ;
  deriv[8] = Point3Dd(-1,0,0) ;
  deriv[9] = Point3Dd(-1,0,0) ;

  PlNurbsCurved curveA,curveB,curveC,curveD;
  class myNurbsCurve : public PlNurbsCurved
  {
  
  };

  myNurbsCurve testCurve;
  curveA.globalInterp(points,3) ;
  curveB.leastSquares(points,3,5) ;
  curveC.leastSquares(points,3,10) ;
